...
(burger.addEventListener("click", () => mm.classList.toggle("open")),
  mm
    .querySelectorAll("a")
    .forEach((e) => e.addEventListener("click", () => mm.classList.remove("open"))));
const io = new IntersectionObserver(
  (e) =>
    e.forEach((e) => {
      e.isIntersecting && (e.target.classList.add("in"), io.unobserve(e.target));
    }),
  { threshold: 0.12 }
);
...
form.addEventListener("submit", function (e) {
  if ((e.preventDefault(), !validateEmail(emailInput.value.trim())))
    return (
    ...
    fetch("https://api.web3forms.com/submit", {
      ...
      .then(async (e) => {
        ...
        200 == e.status
          ...
          : (console.log(e),
            (result.style.color = "#d93838"),
            (result.textContent = t.message || "Something went wrong. Please try again."));
      })
      .catch((e) => {
        (console.log(e),
          (result.style.color = "#d93838"),
